...
const RulesButton = ({ onClick }) => (
  <button onClick={onClick} style={{ width: 36, height: 36, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(255,255,255,0.05)', color: '#888', fontSize: 16, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'serif', fontStyle: 'italic', transition: 'all 0.2s' }}>i</button>
)

const RulesPopup = ({ show, onClose }) => {
  if (!show) return null
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }} onClick={onClose}>
      ...
      <div onClick={e => e.stopPropagation()} style={{ position: 'relative', background: 'linear-gradient(135deg, #1a1a2e, #0f0f23)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 20, width: 'min(92vw, 480px)', maxHeight: '85vh', display: 'flex', flexDirection: 'column', boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 24px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, background: 'linear-gradient(135deg, #00ff88, #00d4ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Regles du Rami 500</h2>
          <button onClick={onClose} style={{ width: 32, height: 32, borderRadius: '50%', border: 'none', background: 'rgba(255,255,255,0.1)', color: '#888', fontSize: 18, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✕</button>
        </div>
        <div style={{ padding: '16px 24px 24px', overflowY: 'auto', fontSize: 14, lineHeight: 1.7, color: '#ccc' }}>
          <RulesSection t="Objectif">Le premier joueur a atteindre <b style={{color:'#00ff88'}}>500 points</b> remporte la partie. Les points s'accumulent a travers plusieurs manches.</RulesSection>
          <RulesSection t="Distribution">Chaque joueur recoit <b style={{color:'#fff'}}>9 cartes</b>. Le reste forme la pioche. La premiere carte est retournee pour former la defausse.</RulesSection>
          <RulesSection t="Tour de jeu">Chaque tour se deroule en 3 etapes :
            <ol style={{ paddingLeft: 20, marginTop: 8 }}>
              <li><b style={{color:'#fff'}}>Piocher</b> — Prendre la carte du dessus de la pioche OU une carte de la defausse (+ toutes les cartes au-dessus)</li>
              <li><b style={{color:'#fff'}}>Poser</b> (optionnel) — Deposer des combinaisons ou ajouter aux combinaisons existantes</li>
              <li><b style={{color:'#fff'}}>Defausser</b> — Se separer d'une carte sur la defausse</li>
            </ol>
          </RulesSection>
          <RulesSection t="Combinaisons valides">
            <div style={{ marginBottom: 8 }}><b style={{color:'#fff'}}>Brelan / Carre :</b> 3 ou plus cartes de meme valeur, couleurs differentes</div>
            <div style={{ display: 'flex', gap: 4, marginBottom: 12 }}>
              <RulesMiniEx>7&#9824;</RulesMiniEx><RulesMiniEx>7&#9829;</RulesMiniEx><RulesMiniEx>7&#9830;</RulesMiniEx>
            </div>
            <div style={{ marginBottom: 8 }}><b style={{color:'#fff'}}>Suite :</b> 3+ cartes consecutives de la meme couleur</div>
            <div style={{ display: 'flex', gap: 4, marginBottom: 8 }}>
              <RulesMiniEx>4&#9829;</RulesMiniEx><RulesMiniEx>5&#9829;</RulesMiniEx><RulesMiniEx>6&#9829;</RulesMiniEx><RulesMiniEx>7&#9829;</RulesMiniEx>
            </div>
          </RulesSection>
          <RulesSection t="Les 2 (Frimes / Jokers)">Les <b style={{color:'#a78bfa'}}>2 de chaque couleur</b> et les <b style={{color:'#a78bfa'}}>Jokers</b> sont des cartes speciales (frimes). Ils peuvent remplacer n'importe quelle carte dans une combinaison. Maximum 1 frime par combinaison.</RulesSection>
          <RulesSection t="Ajouter a une combinaison">Tu peux ajouter une carte a n'importe quelle combinaison sur la table (la tienne ou celle d'un adversaire). Si tu ajoutes a celle d'un adversaire, les <b style={{color:'#00ff88'}}>points comptent pour toi</b>.</RulesSection>
          <RulesSection t="Fin de manche">La manche se termine quand un joueur n'a plus de cartes en main.</RulesSection>
          <RulesSection t="Calcul des points">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '4px 16px', marginTop: 8 }}>
              ...
              <span>Cartes 3 a 10</span><b style={{color:'#00ff88'}}>5 pts</b>
            ...
            <div style={{ marginTop: 12, padding: 12, background: 'rgba(255,255,255,0.05)', borderRadius: 10, fontSize: 13 }}>
              <b style={{color:'#fff'}}>Score = cartes posees - cartes en main</b><br/>
              Les cartes posees rapportent des points, les cartes restantes en main sont soustraites.
            </div>
          </RulesSection>
          <RulesSection t="Piocher dans la defausse">Tu peux prendre n'importe quelle carte visible de la defausse, mais tu dois aussi prendre <b style={{color:'#fff'}}>toutes les cartes au-dessus</b>.</RulesSection>
  ...
  if (!isLoggedIn && gamePhase === 'menu') return (
    <>
      ...
      <div style={{ height: '100vh', background: 'linear-gradient(135deg, #0a0a0f 0%, #1a1a2e 50%, #0f0f23 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Space Grotesk, system-ui', color: '#fff', padding: 20 }}>
        <div style={{ position: 'absolute', top: 16, right: 16 }}><RulesButton onClick={() => setShowRules(true)} /></div>
